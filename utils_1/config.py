...
# =========== save path ================ #
parser.add_argument('--model_name'     ,default='ScaleDense_best_model_0.pth.tar'    ,type=str, help="Checkpoint file name")
...
parser.add_argument('--dis_range'   ,default=0           ,type=int,   help="Discritize step when training the second stage network")
...
parser.add_argument('--lbd',        default=0          ,type=float,   help="The weight between main loss function and auxiliary loss function")
